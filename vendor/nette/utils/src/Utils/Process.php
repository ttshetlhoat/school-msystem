...
final class Process
{
	 ...
	 * To read everything incrementally, poll `while ($p->isRunning())` and call this; the call inside the
	 * last iteration also returns whatever the process wrote just before it finished.
	 */
