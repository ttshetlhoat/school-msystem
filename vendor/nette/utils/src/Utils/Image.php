...
use Nette;
use function func_num_args, is_array, is_int, is_string;
...
class Image
{
	 ...
	 */
	public static function fromFile(string $file, ?int &$type = null, ?string &$warnings = null): static
	{
		...
		return self::invokeSafe('imagecreatefrom' . self::Formats[$type], $file, "Unable to open file '$file'.", __METHOD__, func_num_args() >= 3, $warnings);
	}
	 ...
	 */
	public static function fromString(string $s, ?int &$type = null, ?string &$warnings = null): static
	{
		self::ensureExtension();
		...
		return self::invokeSafe('imagecreatefromstring', $s, 'Unable to open image from string.', __METHOD__, func_num_args() >= 3, $warnings);
	}
